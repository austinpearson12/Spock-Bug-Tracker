...
namespace Spock_Bug_Tracker.Controllers
{
    public class TicketHistoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,PropertyName,OldValue,NewValue,Created,UserId")] TicketHistory ticketHistory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TicketId,PropertyName,OldValue,NewValue,Created,UserId")] TicketHistory ticketHistory)
        {
            if (ModelState.IsValid)
            {
