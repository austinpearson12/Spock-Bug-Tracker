...
namespace Spock_Bug_Tracker.Controllers
{
    ...
    public class TicketNotificationsController : Controller
    {
        ...
        {
            var ticketNotifications = db.TicketNotifications.Include(t => t.Recipient).Include(t => t.Sender);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create([Bind(Include = "Id,TicketId,Created,Subject,NotificationBody,RecipientId,SenderId,IsRead")] TicketNotification ticketNotification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TicketId,Created,Subject,NotificationBody,RecipientId,SenderId,IsRead")] TicketNotification ticketNotification)
        {
            if (ModelState.IsValid)
            {
